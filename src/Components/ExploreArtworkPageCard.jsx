...
const ExploreArtworkPageCard = ({ singlePublicData }) => {
    return (
        <div className="rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2 border-purple-400">
            ...
            <div className="p-5">
                {/* Title */}
                <h3 className="text-lg sm:text-xl font-bold truncate">{singlePublicData.title}</h3>
                ...
                <div className="flex items-center mt-3">
                    ...
                    />
                    <p className="text-sm sm:text-base font-medium">{singlePublicData.artistName}</p>
                </div>

                {/* Category & Price */}
                <div className="flex justify-between items-center mt-4">
                    <span className="bg-purple-300 text-purple-800 px-3 py-1 rounded-full text-sm font-semibold">{singlePublicData.category}</span>
