    ...
    return (
        <div className="rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2 border-purple-400 flex flex-col h-full">
            ...
            <div className="p-5 flex flex-col grow">
                {/* Title with fixed height and truncate */}
                <h3 className="text-lg sm:text-xl font-bold h-12 overflow-hidden line-clamp-2 mb-2">{title}</h3>
                ...
                <div className="flex items-center mt-1">
                    ...
                    />
                    <p className="text-sm sm:text-base font-medium truncate">{artistName}</p>
                </div>

                {/* Category & Price */}
                <div className="flex justify-between items-center mt-4 mb-2">
                    <span className="bg-purple-300 text-purple-800 px-3 py-1 rounded-full text-sm font-semibold truncate max-w-[70%]">{category}</span>
                </div>
