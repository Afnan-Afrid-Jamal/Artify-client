...
const ErrorPage = () => {
    return (
        <>
            <title>ARTIFY - error404</title>
            <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-purple-50 to-violet-100 dark:from-gray-900 dark:to-purple-900">
