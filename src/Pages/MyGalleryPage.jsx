                            ...
                            <div className="p-5 flex flex-col flex-1">
                                ...
                                <div className="flex gap-3 mt-5">
                                    ...
                                    <dialog id="my_modal_5" className="modal modal-middle">
                                        <div className="modal-box max-w-4xl w-11/12 sm:w-full mx-auto p-4 sm:p-6 bg-purple-900">
                                            <h3 className="font-bold text-lg sm:text-xl md:text-2xl mb-4 sm:mb-6">Update Your Artwork</h3>
                                            <div className="modal-action">
                                                <form onSubmit={(event) => handleUpdate(event, art._id)} method="dialog" className="w-full">
                                                    <div className="space-y-4 sm:space-y-6 max-h-[60vh] sm:max-h-[70vh] overflow-y-auto pr-2">
                                                        <div>
                                                            <label className="block mb-2 font-semibold text-sm sm:text-base">Image URL</label>
                                                            <input
                                                                type="text"
                                                                name="imageURL"
                                                                placeholder="https://example.com/your-artwork.jpg"
                                                                defaultValue={art.imageURL}
                                                                className="w-full border-2 border-violet-500 rounded-xl px-3 sm:px-4 py-2 sm:py-3 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 text-sm sm:text-base"
                                                            />
                                                        </div>

                                                        {/* Title */}
                                                        <div>
                                                            <label className="block mb-2 font-semibold text-sm sm:text-base">Artwork Title</label>
                                                            <input
                                                                type="text"
                                                                name="title"
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select
                                                                    ...
                                                                    className="w-full border-2 border-violet-500 rounded-xl px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-violet-300 text-sm sm:text-base"
                                                                >
                                                            ...
                                                            {/* Medium/Tools */}
                                                            <div>
                                                                <label className="block mb-2 font-semibold text-sm sm:text-base">Medium/Tools</label>
                                                                <input
                                                                    type="text"
                                                                    name="medium"
                                                        ...
                                                        <div>
                                                            ...
                                                            <textarea
                                                                ...
                                                                className="w-full border-2 border-violet-500 rounded-xl px-3 sm:px-4 py-2 sm:py-3 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 resize-none text-sm sm:text-base"
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                                            <div>
                                                                <label className="block mb-2 font-semibold text-sm sm:text-base">Dimensions (optional)</label>
                                                                <input
                                                                    type="text"
                                                            ...
                                                            <div>
                                                                <label className="block mb-2 font-semibold text-sm sm:text-base">Price (optional)</label>
                                                                <input
                                                                    type="number"
                                                                    placeholder="0.00"
                                                                    name="price"
                                                        ...
                                                        {/* Visibility */}
                                                        <div>
                                                            <label className="block mb-2 font-semibold text-sm sm:text-base">Visibility</label>
                                                            <select
                                                                name="visibility"
                                    ...
                                    <button onClick={() => handleDelete(art._id)} className="flex-1 flex items-center justify-center gap-2 bg-red-600 text-white font-semibold py-2.5 rounded-lg shadow-md hover:bg-red-700 hover:shadow-lg transition duration-200 hover:cursor-pointer">
                                        <MdDelete size={20} />
                                        Delete
                                    </button>
                                </div>
